...
dublinWeatherElement.textContent = "Temperature is " + data[0].daily.temperature_2m_min[0] +  "C windspeed is " + .daily.wind_gusts_10m_max[0] + " km\\h"
corkWeatherElement.textContent= "Temperature is " + data[1].daily.temperature_2m_min[0] +  "C windspeed is " + .daily.wind_gusts_10m_max[0] + " km\\h"
galwayWeatherElement.textContent = "Temperature is " + data[2].daily.temperature_2m_min[0] +  "C windspeed is " + .daily.wind_gusts_10m_max[0] + " km\\h"
