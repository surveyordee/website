...
dublinWeatherElement.textContent = "Temperature is " + data[0].daily.temperature_2m_min[0] +  "C Max gust windspeed is " + data[0].daily.wind_gusts_10m_max[0] + " km\\h Chance of rain " + data[0].daily.precipitation_probability_min + " %"
...
galwayWeatherElement.textContent = "Temperature is " + data[2].daily.temperature_2m_min[0] +  "C Max gust windspeed is " + data[2].daily.wind_gusts_10m_max[0] + " km\\h Chance of" + data[2].daily.precipitation_probability_min + " %"
})
.catch(error => {
