...
corkWeatherElement.textContent= "<ul><li>Temperature is " + data[1].daily.temperature_2m_min[0] +  "C/li>" +"<li> Max gust windspeed is " + data[1].daily.wind_gusts_10m_max[0] + " km\\h</li>"+ "<li>Chance of rain " + data[1].daily.precipitation_probability_min + " %</li></ul>"
galwayWeatherElement.textContent = "<ul><li>Temperature is " + data[2].daily.temperature_2m_min[0] +  "C/li>" +"<li> Max gust windspeed is " + data[2].daily.wind_gusts_10m_max[0] + " km\\h</li>"+ "<li>Chance of rain " + data[2].daily.precipitation_probability_min + " %</li></ul>"
})
.catch(error => {
